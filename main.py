...
markdown, в формате:
{
  "drawing": "номер чертежа, если виден",
  "positions": [
    {"sortament": "Уголок 100x8", "grade": "Ст3", "mass_kg": 123.4, "qty": 2}
  ]
}
Правила: sortament — тип профиля и размер; grade — марка стали; mass_kg —
масса этой позиции в кг (число); qty — количество. Если чего-то нет — пропусти поле.
